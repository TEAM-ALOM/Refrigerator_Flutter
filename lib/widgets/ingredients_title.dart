...
class _IngredientsTileState extends State<IngredientsTile> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ExpansionTile(
          title: Text(widget.title, style: TextStyle(fontFamily: "CookieRun"),),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildButton(
                              '뒤로 가기', HexColor('#4C4C4C'), Colors.white,
                                  () {
                                Navigator.pop(context);
                              }),
                          _buildButton('확인', HexColor('#FFFFFF'), primary, () async {
                            // 비동기 작업 수행
                            ...
                            final snackBar = SnackBar(
                              content: Text('$ingredient(이)가 냉장고에 추가되었습니다.', style: TextStyle(fontFamily: "CookieRun"),
                                textAlign: TextAlign.center,
                              ),
